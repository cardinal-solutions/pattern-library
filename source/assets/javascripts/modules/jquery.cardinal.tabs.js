...
;(function ( $, window, document, undefined ) {
  ...
  $.cardinal.tabs = function(element, options){
    ...
    base.$element.data("cardinal.tabs", base);
    
    base.init = function(){
      base.options = $.extend({},$.cardinal.tabs.defaultOptions, options);
  ...
  $.cardinal.tabs.defaultOptions = {
    // add options here
  };
  
  $.fn.cardinal_tabs = function(options){
    return this.each(function(){
      (new $.cardinal.tabs(this, options));
    });
  };
